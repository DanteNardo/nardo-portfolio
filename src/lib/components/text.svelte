<script>
	...
	$: css = () => {
		return new CssBuilder()
			...
			.addClass("text-6xl font-extrabold tracking-tight uppercase text-core-900 dark:text-core-100", h1 && resume)
			.addClass("text-3xl mb-2 font-bold text-core-900 dark:text-core-100", h2 && resume)
			.addClass("text-lg mb-1 font-semibold text-core-900 dark:text-core-100", h3 && resume)
			.addClass("text-base mb-1.5 font-normal text-core-900 dark:text-core-100", h4 && resume)
			.addClass("text-xs font-normal text-core-500", h5 && resume)
			.addClass("text-sm mb-4 leading-normal font-normal text-core-500", p && resume)
			.addClass("text-sm mb-1 leading-normal font-normal text-core-500", li && resume)
